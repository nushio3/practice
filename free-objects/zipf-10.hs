...
forZN :: PType (Cons V.Vector (V.Vector Double) (Nil V.Vector)) r=> V.Vector Double -> r
forZN vx = spr (Cons vx (Nil :: Nil V.Vector) :: Cons V.Vector (V.Vector Double) (Nil V.Vector))
