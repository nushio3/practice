...
$ ghc zipf-11.hs
[1 of 1] Compiling Main             ( zipf-11.hs, zipf-11.o )
...
zipf-11.hs:97:3:
    ...
    Note: there are several potential instances:
      instance [overlap ok] (Show a, Show b) => Show (Cons v a b)
        -- Defined at zipf-11.hs:23:54
      instance [overlap ok] Show (Nil v) -- Defined at zipf-11.hs:24:54
      instance Show a => Show (V.Vector a) -- Defined in `Data.Vector'
      ...plus 27 others
    In the expression: print
    In a stmt of a 'do' block: print $ (forZN vd1 vc1 vi1 f_dci_s)
    In the expression:
      do { let args
                 = insert vi1 $ insert vc1 $ insert vd1 (Nil :: Nil V.Vector);
           print $ args;
           print $ (reduceFinal vf1 args);
