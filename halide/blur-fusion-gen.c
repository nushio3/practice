...
if (_172)
{
 ...
 for (int _f7_s0_x_xo_nid = 0; _f7_s0_x_xo_nid < 0 + _225; _f7_s0_x_xo_nid++)
 {
  ...
  int32_t _407 = _406 - _400;
  {
   ...
   int32_t _509 = _489 + 1;
   int32_t _510 = min(_509, 1023);
   int32_t _511 = max(_510, 0);
   int32_t _512 = min(_508, _511);
   int32_t _513 = _489 + -1;
   int32_t _514 = min(_513, 1023);
   ...
   int32_t _530 = _521 + 4;
   int32_t _531 = min(_530, 1023);
   int32_t _532 = max(_531, 0);
   int32_t _533 = max(_529, _532);
   int32_t _534 = _521 + 2;
   int32_t _535 = min(_534, 1023);
   ...
   int32_t _538 = _537 - _516;
   {
    ...
    int32_t _638 = _637 - _631;
    {
     ...
     int32_t _700 = _698 + 1;
     int32_t _701 = min(_700, 1023);
     int32_t _702 = max(_701, 0);
     int32_t _703 = min(_699, _702);
     int32_t _704 = _698 + -1;
     int32_t _705 = min(_704, 1023);
     ...
     int32_t _721 = _719 + 1;
     int32_t _722 = min(_721, 1023);
     int32_t _723 = max(_722, 0);
     int32_t _724 = max(_720, _723);
     int32_t _725 = _719 + -1;
     int32_t _726 = min(_725, 1023);
     ...
     int32_t _729 = _728 - _707;
     {
      ...
      int32_t _789 = _788 - _782;
      {
       ...
       int32_t _795 = _239 + -1;
       int32_t _796 = min(_239, 1023);
       int32_t _797 = max(_796, 0);
       int32_t _798 = max(_795, _797);
       int32_t _799 = _239 + -2;
       int32_t _800 = min(_799, 1023);
       ...
       int32_t _809 = _233 + 1;
       int32_t _810 = min(_809, 1023);
       int32_t _811 = max(_810, 0);
       int32_t _812 = min(_808, _811);
       int32_t _813 = _233 + -1;
       int32_t _814 = min(_813, 1023);
       ...
       int32_t _833 = _832 - _816;
       {
        ...
        int32_t _839 = _239 + -1;
        int32_t _840 = min(_239, 1023);
        int32_t _841 = max(_840, 0);
        int32_t _842 = max(_839, _841);
        int32_t _843 = _239 + -2;
        int32_t _844 = min(_843, 1023);
        ...
        int32_t _850 = _239 + 1;
        int32_t _851 = min(_850, 1023);
        int32_t _852 = max(_851, 0);
        int32_t _853 = min(_849, _852);
        int32_t _854 = min(_839, 1023);
